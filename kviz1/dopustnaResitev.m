function J = dopustnaResitev(c,A,b,maxstep)
...
[x,vr,y,st,J] = simpleksMetoda( c1,A1,b,J1);
if vr ~=0
    ...
    while ~isempty(intersect(J,J1))
        ...
        izstopna = temp(1);
        J = menjavaBaze(c1,A1,b,J,izstopna); %zamenjamo dopolnilno spremenljivko s prvo ki nam ne pridela singularne matrike
    end
